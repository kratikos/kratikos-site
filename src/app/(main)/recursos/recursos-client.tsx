...
const mainFeatures = [
	{
		...
		details: [
			{ icon: <ThumbsUp size={16} />, text: "Votos positivos para concordar" },
			{
				...
				text: "Votos negativos para discordar",
			},
				...
				<div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					>
						...
						<p className="text-lg text-gray-500 leading-relaxed">
							Cada funcionalidade foi criada para tornar a sua opinião visível —
							em votações, enquetes e discussões sobre os temas que mais
							importam para você.
						</p>
					</motion.div>
				</div>
