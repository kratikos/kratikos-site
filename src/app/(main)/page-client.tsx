					...
					>
						...
						>
							...
							<span className="text-sm text-gray-400">
								Plataforma de Engajamento Democrático
							</span>
						</motion.div>
						...
						>
							A rede social de opinião onde você vota, comenta e descobre o que
							a sociedade pensa sobre política, economia, esportes e mais.
						</motion.p>
						...
						>
							<div className="relative">
								...
								>
									...
									<div>
										<p className="text-white font-semibold">
											+{formatStatText(stats?.todayVotes ?? 2500000)}
										</p>
								...
								>
									...
									<div>
										<p className="text-white font-semibold">
											{formatStatText(stats?.activeUsers ?? 150000, "", "+")}
										</p>
										<p className="text-gray-400 text-sm font-medium">
											Usuários ativos
										</p>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					>
						...
						<p className="text-gray-400 text-lg max-w-2xl mx-auto">
							Participe de enquetes e debates em diferentes escalas — do que é
							notícia lá fora ao que acontece perto de você.
						</p>
					</motion.div>
			...
			<section className="relative py-24 lg:py-32 bg-white/[0.01] border-y border-white/5">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid grid-cols-1 sm:grid-cols-3 gap-8 lg:gap-12">
						<StatsCounter
							value={stats?.activeUsers ?? 150000}
							suffix="+"
							label="Usuários Ativos"
							delay={0}
						/>
						<StatsCounter
							value={stats?.totalVotes ?? 2500000}
							suffix="+"
							label="Votos Registrados"
							delay={0.1}
						/>
						<StatsCounter
							value={stats?.totalDiscussions ?? 85000}
							suffix="+"
							label="Discussões Criadas"
							delay={0.2}
						/>
					</div>
				</div>
			...
			<section className="relative py-24 lg:py-32">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					>
						...
						<p className="text-gray-400 text-lg max-w-2xl mx-auto">
							Tudo o que você precisa para opinar, votar e acompanhar o que a
							sociedade pensa.
						</p>
					</motion.div>
				...
				<div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					>
						...
						<p className="text-gray-400 text-lg max-w-xl mx-auto mb-10">
							Baixe o Kratikos gratuitamente e comece a votar, comentar e
							descobrir o que as pessoas realmente pensam.
						</p>
