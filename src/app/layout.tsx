...
import "./globals.css";
import { OptimizedGTM, SubdomainCorrector } from "@/components";
...
export const metadata: Metadata = {
	...
	description:
		"Plataforma de engajamento democrático. Participe de discussões políticas e sociais em nível internacional, nacional e regional.",
	keywords:
		"democracia, engajamento cívico, política, discussões, votação, cidadania",
	authors: [{ name: "Kratikos" }],
	openGraph: {
		title: "Kratikos - Engajamento Democrático",
		description:
			"Plataforma de engajamento democrático. Participe de discussões políticas e sociais.",
		type: "website",
		locale: "pt_BR",
		siteName: "Kratikos",
		images: [
...
const jsonLd = [
	{
		...
		description:
			"Plataforma de engajamento democrático para discussões políticas e sociais.",
		potentialAction: {
			"@type": "SearchAction",
	...
	},
	{
		...
		sameAs: [
			"https://x.com/Kratikosoficial",
			"https://www.tiktok.com/@kratikosoficial",
			"https://www.instagram.com/kratikosoficial",
			"https://www.linkedin.com/company/kratikos/",
		],
	},
	{
		"@context": "https://schema.org",
